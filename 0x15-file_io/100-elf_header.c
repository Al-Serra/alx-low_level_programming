...
/**
 * printdata - prints info about data organization
 * from the elf header
...
/**
 * printabi - prints abi version from header info
 * @head: header information
 * Return: void
 */
...
/**
 * printentry - prints entry address of executable from the header
 * @head: header information
 * Return: void
 */
